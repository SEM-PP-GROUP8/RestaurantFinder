...
public class Model 
{
    ...
    public static final String [] typeFoodArray = new String[]{"All", "Indian", "Thai", "Italian", "Pizza", "Fast Food", "Kebab"};; //Array of possibilities for the type of food (Drop downs load from here)
    public static final String [] locationArray = new String[] {"All", "Center", "Haga", "Lindholmen", "Johanneberg", "Gamlestan", "Oldskroken", "Stampen"}; //Array of possibilities for the different locations (Drop downs load from here)
    public static final String [] timeArray = new String [] {"All", "00:00", "01:00", "02:00", "03:00", "04:00", "05:00", "06:00", 
